...
// Difere do cliente em: type="professional" e redireciona para onboarding.
    ...
    register.mutate(
      {
        ...
        // Diferença crítica: profissional vs cliente
        type: "professional",
      },
      {
        onSuccess: () => {
          // Após registro, profissional deve completar onboarding de 4 passos
          router.replace("/(onboarding)/professional-type");
        },
        onError: (error) => {
          setError("root", {
            message:
  ...
  return (
    <SafeAreaView style={styles.safe} edges={["top", "bottom"]}>
      ...
      >
        ...
        >
          <Text style={styles.title}>Criar conta de parceiro</Text>
          <Text style={styles.subtitle}>
            Seus dados para começar a atender clientes.
          </Text>
...
const styles = StyleSheet.create({
  ...
  loginLink: { alignItems: "center", gap: spacing.sm },
  loginText: {
    fontFamily: "PlusJakartaSans_400Regular",
    fontSize: 14,
    color: colors.textSecondary,
