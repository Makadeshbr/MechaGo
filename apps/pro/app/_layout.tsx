...
// Após esse tempo, a splash é escondida mesmo sem fontes — o app usa fallback do sistema.
...
SplashScreen.preventAutoHideAsync().catch(() => {
  // Silencia erro se chamado após a splash já ter sido escondida (ex: hot reload)
});
